      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <button
            ...
            className="inline-flex items-center justify-center px-8 py-4 text-sm font-medium bg-white text-black hover:bg-white/90 transition-all duration-300 rounded-sm animate-fade-in-up stagger-2"
          >
            Request a Quote
          </button>
        </div>
